...
// Gaetan: j'ai modifié ce fichier pour qu'il permette le rendu de l'objet 3ds chargé

// uncomment next line if you want to create textures and to be able to
// to render the object automatically.
// ONLY WORKS WITH OPENGL
#define __3DSLOADER_LOADWITH_OPENGL__
...
// Il faut désactiver le warning C4786 (le debugger supporte pas des noms de 
// plus de 256 caractères, ce qui pose plein de warning avec par exemple:
// stack <string> truc;
#ifdef WIN32
...
///////////////////////////////////////////////////////////////////////////////////////////
#define MAX_TEXTURES_BY_OBJ 512

  
// This is our 3D point class.  This will be used to store the vertices of our model.
struct C3dsLoaderVector3 
{
    float x, y, z;
};

// This is our 2D point class.  This will be used to store the UV coordinates.
struct C3dsLoaderVector2 
{
    float x, y;
};
...
struct t3DObject 
{
    ...
    C3dsLoaderVector3  *pVerts;          // The object's vertices
    C3dsLoaderVector3  *pNormals;        // The object's normals
    C3dsLoaderVector2  *pTexVerts;       // The texture's UV coordinates
...
public:
    ...
    CLoad3DS( const CLoad3DS &);
    // This is the function that you call to load the 3DS
    bool Import3DS(char *strFileName);
    t3DModel m_model3D;                                     // This holds the 3D Model info that we load in
    unsigned m_texture[MAX_TEXTURES_BY_OBJ];                     // This holds the texture info, referenced by an ID

    #ifdef __3DSLOADER_LOADWITH_OPENGL__
    int m_displaylist;
    void Render();
    void AssignMaterial(tLightMaterial &lightmaterial);
    #endif
...
private:
    ...
    #ifdef __3DSLOADER_LOADWITH_OPENGL__
    bool m_custom_material_enabled;
    tLightMaterial m_lightmaterial;
    #endif
...
struct t3DTextures
{
    unsigned int m_textures_number;
    vector<string> m_textures_filenames;
    vector<unsigned int> m_textures;
    t3DTextures(){ m_textures_number=0;}
...
inline void t3DTextures::clear()
{
#ifdef __3DSLOADER_LOADWITH_OPENGL__
  for (unsigned int i = 0 ; i < m_textures_number ; ++i)
  {
    glDeleteTextures(1, &m_textures[i]);
  }
#endif
  m_textures.clear();
  m_textures_filenames.clear();
  m_textures_number = 0;
}
...
struct t3DObjects
{
    ...
    vector<string> m_objects_filenames;
    vector<CLoad3DS*> m_objects;
    t3DObjects(){ m_objects_number=0;}
    ~t3DObjects()
    {
